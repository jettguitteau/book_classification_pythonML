...
\midrule
Dummy Regressor   & 0.2918 & 0.2974 & -0.0002 \\
...
%---------------------------------------------------------------------
\section{Conclusion}
We successfully built a machine learning pipeline that predicts book ratings with a test RMSE of 0.2434 and an R\textsuperscript{2} of 0.3303. The Light GBM model was selected as the final model and was deployed as an interactive Streamlit application.
